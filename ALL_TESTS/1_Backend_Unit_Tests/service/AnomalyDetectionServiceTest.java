...
class AnomalyDetectionServiceTest {
    ...
    void testHighZScore_AlertTriggered() {
        ...
        verify(notificationService)
                .sendNotification(
                        eq(userId),
                        contains("Cảnh báo chi tiêu bất thường"),
                        eq("SPENDING_ANOMALY"));
    }
    ...
    void testTooFewHistoryEntries_Skip() {
        ...
        List<Transaction> history =
                buildHistoryTransactions(new BigDecimal("150000"), new BigDecimal("180000"));
    ...
    void testAmountBelowThreshold_Skip() {
        ...
        verify(transactionRepository, never())
                .findRecentExpensesByCategory(any(), any(), any(), any(), any());
        verify(notificationService, never()).sendNotification(any(), any(), any());
    }
