...
export function ConfirmCashDialog({ open, debtorName, amount, onConfirm, onCancel }: ConfirmCashDialogProps) {
    ...
    >
      ...
      >
        ...
        <div className="relative mb-5">
          ...
          <span className="absolute top-1/2 -left-5 text-blue-300 text-base">✦</span>
          <span className="absolute -bottom-1 right-3 text-pink-300 text-base">✦</span>
        </div>

        {/* Title */}
        <h2 className="text-xl font-bold leading-tight mb-2 px-2" style={{ color: "#8B5E3C" }}>
          Xác nhận đã nhận tiền mặt?
        </h2>

        {/* Subtitle */}
        <p className="text-gray-500 text-sm leading-snug mb-1 px-2">
          <span className="font-semibold text-gray-700">{debtorName}</span> đã báo chuyển
        </p>
