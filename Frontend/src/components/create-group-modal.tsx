...
export function CreateGroupModal({ onClose, onCreated, open, onOpenChange, onGroupCreated }: CreateGroupModalProps) {
  ...
  return (
    ...
    >
      {/* Drawer */}
      <div className="w-full max-w-lg bg-white rounded-t-[40px] p-6 pb-10 shadow-2xl"
        style={{ animation: "slideUp 0.25s ease-out" }}>
        {/* Handle */}
        <div className="w-12 h-1.5 bg-gray-300 rounded-full mx-auto mb-5" />

        <h2 className="text-xl font-bold text-gray-800 text-center mb-6">Tạo nhóm mới</h2>

        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          <div>
            <label className="text-xs font-semibold text-gray-600 block mb-1.5">Tên nhóm *</label>
            <input
              type="text"
          ...
          <div>
            <label className="text-xs font-semibold text-gray-600 block mb-1.5">Mô tả (tùy chọn)</label>
            <textarea
