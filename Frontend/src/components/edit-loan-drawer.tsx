...
export function EditLoanDrawer({ open, onOpenChange, loan, onSaved }: EditLoanDrawerProps) {
  ...
  const [principalAmount, setPrincipalAmount] = useState(new Intl.NumberFormat("vi-VN").format(loan.principalAmount));
  ...
  useEffect(() => {
    if (open && loan) {
      ...
      setPrincipalAmount(new Intl.NumberFormat("vi-VN").format(loan.principalAmount));
          ...
          <div className="bg-white p-5 rounded-[24px] shadow-sm space-y-4">
            <div>
              ...
              <Input
                ...
                placeholder={type === "LENT" ? "VD: Thằng bạn thân..." : "VD: FE Credit..."}
            ...
            <div className="flex items-center gap-2 pt-2">
              ...
              />
              <label htmlFor="isSettled" className="text-sm font-bold text-gray-700">Đã thanh toán (Trả xong)</label>
            </div>
          </div>
