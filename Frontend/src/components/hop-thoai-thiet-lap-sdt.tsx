...
export function PhoneSetupModal({
    ...
    try {
      ...
      setPhoneError(
        err?.response?.data?.message ||
          "Đã có lỗi xảy ra khi cập nhật số điện thoại.",
      );
    } finally {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/40 backdrop-blur-sm px-4">
      <div
        className="w-full max-w-md bg-[#e2f8f4] rounded-3xl p-6 shadow-2xl border border-white/50 relative overflow-hidden"
        style={{
      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-center">
          ...
          <h2 className="text-2xl font-extrabold text-[#437d6e] mb-2 text-center">
            Cập nhật Số điện thoại
          </h2>
          <p className="text-sm text-[#437d6e]/80 mb-6 text-center leading-relaxed">
            Bạn cần thêm số điện thoại để bạn bè có thể tìm thấy và mời bạn vào
            nhóm.
          </p>
