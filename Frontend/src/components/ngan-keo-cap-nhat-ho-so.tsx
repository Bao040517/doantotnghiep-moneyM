...
export function ProfileSetupDrawer({
  children,
  onSave,
}: {
      ...
      <DrawerTrigger asChild>
        {children || (
          <Button
            variant="ghost"
            size="icon"
            className="text-slate-600 dark:text-slate-400 hover:text-indigo-600 dark:hover:text-indigo-400 bg-white/50 dark:bg-slate-800/50 rounded-full h-10 w-10 border border-slate-200 dark:border-slate-700"
          >
        ...
        <div className="mx-auto w-full max-w-sm px-4 pb-8 pt-4 overflow-y-auto max-h-[90vh]">
            ...
            <div className="flex-shrink-0 w-40 flex flex-col items-center bg-emerald-50 rounded-xl p-3 border border-emerald-100 snap-center">
              ...
              {user?.bankBin && user?.bankAccountNo ? (
                <Dialog>
                  ...
                  <DialogContent
                    className="max-w-sm bg-white flex flex-col items-center justify-center p-8 border-none shadow-2xl rounded-3xl"
                  ...
                  >
                    ...
                    />
                    <p className="text-emerald-700 font-bold mt-4">
                      Mã VietQR của bạn
                    </p>
                  </DialogContent>
                </Dialog>
                ...
                <div className="bg-white/50 p-2 rounded-lg w-full aspect-square flex flex-col items-center justify-center border border-emerald-200 border-dashed">
                  ...
                  <span className="text-[10px] text-emerald-600 text-center font-medium">
                    Chưa cấu hình
                  </span>
                </div>
              )}
            ...
            <div className="flex-shrink-0 w-40 flex flex-col items-center bg-blue-50 rounded-xl p-3 border border-blue-100 snap-center">
              ...
              {user?.bankQrUrl ? (
                ...
                <div className="bg-white/50 p-2 rounded-lg w-full aspect-square flex flex-col items-center justify-center border border-blue-200 border-dashed">
                  ...
                  <span className="text-[10px] text-blue-600 text-center font-medium">
                    Chưa có ảnh tĩnh
                  </span>
                </div>
              )}
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              ...
              <Select
                value={bankBin}
                onValueChange={(val) => setBankBin(val || "")}
              >
                <SelectTrigger>
                  <span
                    className={`flex-1 text-left ${!bankBin ? "text-slate-500" : ""}`}
                  >
                    {bankBin
                      ? (() => {
                          const b = POPULAR_BANKS.find(
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-slate-500">
                Nếu nhập, chúng tôi sẽ dùng ảnh này trong trường hợp sinh mã tự
                động thất bại.
              </p>
            </div>
