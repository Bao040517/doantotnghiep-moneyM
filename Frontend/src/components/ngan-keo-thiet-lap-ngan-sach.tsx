      ...
      <DrawerContent className="bg-gradient-to-b from-[#f0faf8] to-[#e0f4f0] rounded-t-[40px] px-0 pb-0 border-none max-h-[95vh] flex flex-col font-sans overflow-hidden">
        ...
        <div className="absolute top-8 right-5 opacity-60 pointer-events-none">
          <img
            alt="Target"
            className="w-24 h-24"
            src="https://lh3.googleusercontent.com/aida-public/AB6AXuDobG54qzOgdHgMZox8rd7DSIOhaOkv4-6KC31jbCAmWpPTYl_AAjDiCjkWFCkqrJZcwt0cMlEp0rUuRpDpSie1sBcrmkcAXXNRx1LUVeQYC8CcO86eo9Xs38QZLK_HI5bHC9j-FtTKwKe8LzEo558ZvzS32_V4E9Y3G-QuPfDgYEutbyx5kq3i9C6FbyJKBSU93b-mCmGny1Zrd9LBW_kMKLmHdzlw4nphXmzy31o8fDQUH7uCog5GzhL0mAOirzZ-D2fKmBSpmuc"
          />
        </div>
        <div className="absolute top-[180px] right-[30px] opacity-90 z-0 pointer-events-none">
          <img
            alt="Piggy Bank"
            className="w-20 h-20"
            src="https://lh3.googleusercontent.com/aida-public/AB6AXuAtghcuUgPPi5Q-eIs0cuF9E42ywTt0j5wThayXKT7hTG11thYTI8bLqtuHHgoEb7xGrqCnqAReXA7m4tke6ZssoArSB8hzQJWVjm0sXo2LF1HAcx-Sx3lSImrf2q1MGeY4T48H3m5peMGZ-P1t4AVcWHhfdEaUk3-9f-Ff_kKPKezKMKPsgviqyIW6G2M5EV2jAf6lSI9pVUUUPP8j0DuNpdW8OrwFElCZ-BW3PIZtM9j8NkIBvyeKfBjkDkyyF2_nv5KhYNqbjo8"
          />
        </div>
              ...
              <div className="bg-white/80 backdrop-blur-sm rounded-[24px] p-3.5 flex items-center shadow-[0_8px_30px_rgba(31,77,68,0.06)] border border-[#66c2b1]/30 transition-all focus-within:bg-white focus-within:border-[#66c2b1] focus-within:shadow-[0_8px_30px_rgba(31,77,68,0.12)]">
                <div className="mr-4 text-[#66c2b1]">
                  <img
                    alt="Pencil"
                    className="w-7 h-7"
                    src="https://lh3.googleusercontent.com/aida-public/AB6AXuC0k2nvrVf8h77CIl7mJAJsZKst1b1fMW64-rwnRrvMM9eT0B17FZaPeGIsw9unDzdhwUlOQjLlyOMkK33ep560Zmd-4PjQqwWzG6GhmqVRSMv9vZM97CwOwwWx3Gkt3a608hI5pz1ZZH5OZrqia3H10z5__YZvKKasOhxoYpy3dFQKwR2vJxTa7y5xto_F5xpRFcQ3Jytb-Qq0VnRnc-ASJ1vdwBsDz4egJvzi3hMFCzONVBrySN38murB2hbX4bmUlICFzmwxESA"
                  />
                </div>
                <input
                  type="text"
                ...
                <div className="p-3.5 flex items-center">
                  <div className="mr-4">
                    <img
                      alt="Coin"
                      className="w-7 h-7"
                      src="https://lh3.googleusercontent.com/aida-public/AB6AXuBC2Da-YD4IZGX7oZjkp0YdzG2YT_8MPikbRQvHWLvyMob5kZ5kv1zZovHC26xYDYBMq3itDp7e9yE7HiKrXBfh_NQAyjnx4h_c5PMV-24HSCIjghsT_1HOmLaMxA1GU12EKcCXaFq38yVIC4pxSDWLbXlbgoIRiuOAXReo7HDKK-yDv42kMmANAAasdNnNnRG_aNyzKBuTa7szo1aZPI4N9SmEbJ2-V-yzUFMnxaSm3GEGV_h55VR-CCfp6zhXKYfoQAGzFHBxpIg"
                    />
                  </div>
                  <input
                    type="text"
                ...
                <div className="border-t border-[#66c2b1]/20 p-1.5 relative">
                  ...
                  >
                    ...
                    <SelectContent
                      ...
                      className="rounded-2xl border-none shadow-[0_10px_40px_rgba(31,77,68,0.15)] z-[100] bg-white max-h-[40vh]"
                    >
                      {categories.map((c) => (
                        <SelectItem
                          key={c.id}
                ...
                <div className="flex flex-col gap-1.5">
                  <div className="flex justify-between items-center">
                    <div className="flex items-center gap-2">
                      ...
                      <button
                        ...
                        className="w-[18px] h-[18px] rounded-full bg-slate-200 text-slate-500 text-[11px] flex items-center justify-center font-bold pb-px hover:bg-slate-300 transition-colors"
                      >
                        ?
                      </button>
                    </div>
                    <div className="relative inline-block w-12 h-7 align-middle select-none">
                      ...
                      <label
                        htmlFor="toggle2"
                        className={`toggle-label block overflow-hidden h-7 rounded-full cursor-pointer relative transition-colors duration-300 ${isMandatory ? "bg-[#a7f3d0]" : "bg-gray-200"}`}
                      >
                        <span
                          className={`absolute top-[2px] left-[2px] w-[24px] h-[24px] bg-white rounded-full transition-transform duration-300 shadow-[0_2px_4px_rgba(0,0,0,0.1)] ${isMandatory ? "translate-x-[20px]" : "translate-x-0"}`}
                        />
                      </label>
                    </div>
                  </div>
                  {activeTooltip === "mandatory" && (
                    <div className="text-[13px] text-slate-500 bg-slate-50 p-2.5 rounded-xl border border-slate-100 animate-in fade-in slide-in-from-top-1">
                      Hệ thống sẽ ưu tiên trích tiền từ ví cho các khoản này
                      trước.
                    </div>
                  )}
                </div>
                ...
                <div className="flex flex-col gap-1.5">
                  <div className="flex justify-between items-center">
                    ...
                    <div className="relative inline-block w-12 h-7 align-middle select-none">
                      ...
                      <label
                        htmlFor="toggle3"
                        className={`toggle-label block overflow-hidden h-7 rounded-full cursor-pointer relative transition-colors duration-300 ${isRecurring ? "bg-[#a7f3d0]" : "bg-gray-200"}`}
                      >
                        <span
                          className={`absolute top-[2px] left-[2px] w-[24px] h-[24px] bg-white rounded-full transition-transform duration-300 shadow-[0_2px_4px_rgba(0,0,0,0.1)] ${isRecurring ? "translate-x-[20px]" : "translate-x-0"}`}
                        />
                      </label>
                    </div>
                  </div>
