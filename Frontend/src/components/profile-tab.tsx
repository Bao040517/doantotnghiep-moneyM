...
export function ProfileTab({ currentUser, onOpenPhoneModal, onLogout, onProfileSaved }: ProfileTabProps) {
  return (
    <main className="px-5 mt-8 max-w-md mx-auto w-full pb-28">
      ...
      <section className="space-y-4">
        ...
        {/* Logout Card */}
        <button onClick={onLogout} className="w-full bg-[#fcf9f2] rounded-[1.25rem] p-4 flex items-center justify-center gap-2 text-red-500 shadow-sm hover:bg-red-50 transition-colors mt-8">
