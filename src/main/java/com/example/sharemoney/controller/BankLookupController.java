...
@Tag(
        ...
        description = "API tra cứu và xác thực tên chủ tài khoản ngân hàng Napas247")
public class BankLookupController {
    ...
    public ResponseEntity<BankLookupResponse> lookupAccount(
            @Valid @RequestBody BankLookupRequest request) {
        BankLookupResponse response =
                bankLookupService.lookupAccount(request.getBin(), request.getAccountNumber());
