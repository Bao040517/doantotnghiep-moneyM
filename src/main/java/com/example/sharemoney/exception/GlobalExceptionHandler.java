...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleTypeMismatch(
        ...
        return ResponseEntity.badRequest().body(buildError(400, "TYPE_MISMATCH", message));
    }
    ...
    public ResponseEntity<ErrorResponse> handleMissingParam(
        ...
        return ResponseEntity.badRequest().body(buildError(400, "MISSING_PARAMETER", message));
    }
        ...
        return ResponseEntity.status(HttpStatus.PAYLOAD_TOO_LARGE)
                .body(
                        buildError(
                                413,
                                "FILE_TOO_LARGE",
                                "Kích thước tập tin tải lên vượt quá giới hạn tối đa cho phép."));
    }
        ...
        return ResponseEntity.status(HttpStatus.UNSUPPORTED_MEDIA_TYPE)
                .body(
                        buildError(
                                ...
                                "Định dạng dữ liệu gửi lên (Content-Type) không được hỗ trợ."));
    }
