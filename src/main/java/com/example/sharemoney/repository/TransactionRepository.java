...
public interface TransactionRepository extends JpaRepository<Transaction, UUID> {
        ...
        @Query("SELECT COALESCE(SUM(s.amount), 0) FROM TransactionSplit s "
                        ...
                        + "AND s.parentTransaction.linkedBudgetId IS NULL "
        ...
        default BigDecimal sumExpenseByCategoryAndMonth(UUID userId, UUID categoryId, int year, int month) {
